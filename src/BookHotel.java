...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		contentPane.add(btnExit);
                ...
                myhotel = new JButton("Booked Hotel");
                myhotel.setLayout(null);
                myhotel.setBounds(550,470,150,30);
                myhotel.setBackground(Color.BLACK);
                myhotel.setForeground(Color.white);
                myhotel.addActionListener(new ActionListener()
                {
                    public void actionPerformed(ActionEvent e)
                    {
                       ViewBookedHotel vb = new ViewBookedHotel(username);
                       vb.setVisible(true);
                        setVisible(false);
                    }
                });
                contentPane.add(myhotel);
